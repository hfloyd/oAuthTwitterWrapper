...
namespace OAuthTwitterWrapper
{
    class Authenticate : IAuthenticate
    {
        public AuthResponse AuthenticateMe(IAuthenticateSettings authenticateSettings)
        {
            ...
            if (string.IsNullOrEmpty(authenticateSettings.OAuthUrl))
            {
                throw new TwitterAuthenticateMissingUrlException();
            }
    ...
    public class TwitterAuthenticateMissingUrlException : Exception
    {
        ...
        public TwitterAuthenticateMissingUrlException()
        {
            _message = "AuthenticateSettings.OAuthUrl is missing. Add key='oAuthUrl to your web.config, or set the 'AuthenticateSettings.OAuthUrl' explicitly in your code before calling AuthenticateMe().";
        }
    }
}
